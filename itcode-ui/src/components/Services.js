...
const Services = () => {
  ...
  return (
    ...
    <div className=" text-white mt-40 pl-5">
     <div className="text-white bg-red-900 hover:bg-red-600 hover:text-green-300  text-4xl font-extrabold border border-solid border-black cursor-pointer h-60 ml-5 flex justify-start items-center rounded-xl" style={backgroundStyle} onClick={handleOpenModal}>
    ...
    <Modal
      ...
      >
        <img src={close} className="closeMenu h-5 cursor-pointer ml-64 -mr-20 -mt-10 hover:filter: brightness-100" onClick={handleCloseModal} alt="Close" ></img>
