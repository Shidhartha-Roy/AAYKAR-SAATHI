...
const About = () => {
  ...
  return (
    ...
    <div className="flex items-center -mt-32">
      <img src={logo} className="w-100 h-72 border-4 border-yellow-300 p-2 -ml-22" />
      <motion.div 
      ...
      className="ml-10">
        <div className="text-xl text-green-500 font-bold -mt-7" style={{textAlign: "left"}}>
          DESCRIPTION:
        </div>
        <div className="text-lg tracking-wider font-semibold text-green-100 max-w-3xl" style={{textAlign: "left"}}>
        ...
        <div className="text-xl text-green-500 mt-7 font-bold" style={{textAlign: "left"}}>
          DEVELOPED BY:
        </div>
        <div className="text-lg text-green-100 max-w-lg" style={{textAlign: "left"}}>
